/**********************************************************************************************************************
 **
 ** assemblies/horizontal_front.scad
 **
 ** This file renders and provides the horizontal parts on the front side with whatever is attached to it. 
 ...
 */
module horizontal_front_assembly(position = [0, 0, 0], angle = 0, with_connectors = false) {
	translate(position)
		rotate([0, 0, angle]) {
			_horizontal_front_assembly();
			// TODO connectors
		}
}
...
_horizontal_front_assembly(with_connectors = true);