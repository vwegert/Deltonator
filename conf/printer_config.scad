...
// // The height of the bracket that holds the motor. WARNING: Increasing this will make it difficult to 
...
// // The diameter of the head of the screws used to assemble the frame.
