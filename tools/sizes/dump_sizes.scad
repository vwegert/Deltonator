...
echo(ps_width_additional_clearance = ps_width_additional_clearance());
echo(ps_height_additional_clearance = ps_height_additional_clearance());
echo(ps_base_mount_screw_size = ps_base_mount_screw_size());
echo(ps_base_mount_screw_min_length = ps_base_mount_screw_min_length());
echo(ps_base_thickness = ps_base_thickness());
echo(ps_base_inner_width = ps_base_inner_width());
echo(ps_base_inner_height = ps_base_inner_height());
echo(ps_base_strut_width = ps_base_strut_width());
