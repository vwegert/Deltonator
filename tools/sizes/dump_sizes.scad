...
echo(angle_rail_a = angle_rail_a());
echo(angle_rail_b = angle_rail_b());
echo(angle_rail_c = angle_rail_c());
echo(angle_rails = angle_rails());
echo(position_rail_a = position_rail_a());
echo(position_rail_b = position_rail_b());
echo(position_rail_c = position_rail_c());
echo(position_rails = position_rails());
